...
#Set env vars
buildDir = BUILDDIR
if "ENERGID" not in os.environ:
    os.environ["ENERGID"] = buildDir + '/src/energid' + EXEEXT
if "ENERGICLI" not in os.environ:
    os.environ["ENERGICLI"] = buildDir + '/src/energi-cli' + EXEEXT
